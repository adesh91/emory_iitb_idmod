...
parms <- c(alpha = 14,         # alpha = daily contacts
           ...
           rel_inf_2 = 0.5, # relative reduction in infectiousness for secondary infection vs. primary
           rel_inf_3 = 0.1, # relative reduction in infectiousness for tertiary infection vs. primary  
           age_2m = 1/56, # 2 month aging rate
           age_3m = 1/84, # 3 month aging rate
           age_53m = 1/1484, # 53 month aging rate
           chi = (0.05/365) # daily vaccination rate
           )    
